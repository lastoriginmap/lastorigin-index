    ...
    return (
      <div className="info-container">
        ...
        <div className="spec-wrap">
          <div className="spec-item spec-item-header" id="HP"><img src="images/icon_HP2.png" alt="HP Icon" /><div>HP</div></div><div className="spec-item" id="HP"><Tooltip tooltipdata={{...enemyData.HP, "increment":Math.floor(enemyData.HP.increment)}} isStatExpanded={this.state.isStatExpanded}><span className="tooltip-text" onClick={this.toggleExpandStat}>{this.calcLvlValue({...enemyData.HP, "increment":Math.floor(enemyData.HP.increment)}, lvl)}</span></Tooltip></div>
